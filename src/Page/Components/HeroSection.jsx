...
function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Changed flex-col-reverse to put image first on mobile */}
      <div className="container mx-auto z-10 flex flex-col-reverse md:flex-row items-center justify-between gap-12 text-left">
        {/* Text content - now comes after image in DOM order */}
        <div className="space-y-4 text-left pt-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 justify-start text-center ">
             ...
             <a
  href="https://drive.google.com/file/d/1A1f4XseUnyte8NgBDZ-KucY6pyNMJ0I-/view?usp=sharing"
